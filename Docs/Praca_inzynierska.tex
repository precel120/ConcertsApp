...
\subsection{Node.js}
{
  ...
  zwykłe aplikacje, aplikacje z dziedziny IoT(Internet of Things), posiada nawet pakiety do uczenia maszynowego. Za pomocą Node jesteśmy w stanie wykonać przeróżne rzeczy 
  ...
  \begin{figure}[H]
    ...
    \label{fig:backend}
  \end{figure}
  Jak zostało zaprezentowane na obrazku \ref{fig:backend}, Node.JS cieszy się ogromną popularnością. Uzyskał 51.9\% na 33 913 ankietowanych, tę grupę stanowili jedynie profesjonalni developerzy.
  \begin{figure}[H]
    \centering
  ...
  wśród frameworków back endowych, osiągnął popularność na poziomie 20.9\%. Wyprzedza takie frameworki jak: Java Spring, Flask, Django, Laravel czy Ruby on Rails, jedynie ASP.NET plasuje się wyżej w rankingu. 
}
\subsection{React.js}
{
